...
const dropdownPerusahaan = qoreApps.registerComponent("dropdownPerusahaanV0.1.1", {
    type: "none",
    icon: "TextInput",
    group: "input",
    propDefinition: {
    ...
    Component: (props) => {
        ...
        const defaultValue = React.useMemo(() => !propsDefaultValue
            ? undefined
            : apiData.find((item) => item.value.kode_perusahaan === propsDefaultValue), [propsDefaultValue, apiData]);
        // @ts-ignore
        const perusahaanId = props.hooks.useRuntimeInput(props.properties.perusahaanId, props.data.page.row, {
            validate: (value) => {
        ...
        // @ts-ignore
        const perusahaanName = props.hooks.useRuntimeInput(props.properties.perusahaanName, props.data.page.row, {
            validate: (value) => {
                if (typeof value === "undefined") {
                    return { error: "" };
                }
        ...
        const fetchAPIData = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const { data } = yield client.project.axios({
                    method: "POST",
                    url: "https://production-qore-data-greece-323966.paraqore.com/v1/execute",
                    data: {
                        operations: [
                            {
                                operation: "Select",
                ...
                const selectOptions = data.results.perusahaan.map((item) => {
                    return {
                        value: item,
                        label: item.name,
                    };
                });
                setApiData(selectOptions);
            }
            catch (error) {
                return error;
            }
        ...
        React.useEffect(() => {
            if (defaultValue) {
                perusahaanId.onChange(defaultValue === null || defaultValue === void 0 ? void 0 : defaultValue.value.kode_perusahaan);
                perusahaanName.onChange(defaultValue === null || defaultValue === void 0 ? void 0 : defaultValue.value.name);
            }
        }, [defaultValue]);
        React.useEffect(() => {
            perusahaanId.onChange(checkedItem === null || checkedItem === void 0 ? void 0 : checkedItem.kode_perusahaan);
            perusahaanName.onChange(checkedItem === null || checkedItem === void 0 ? void 0 : checkedItem.name);
        }, [checkedItem]);
        return (ReactJSX.jsx(Box, { children: isLoading ? (ReactJSX.jsxs(VStack, { w: "full", justifyContent: "start", children: [ReactJSX.jsxs(Flex, { w: "full", children: [ReactJSX.jsx(Text, { fontSize: "18px", color: "#001E4D", children: "Perusahaan" }), ReactJSX.jsx(Text, { color: "red.400", ml: "4px", children: "*" })] }), ReactJSX.jsx(Box, { w: "full", children: ReactJSX.jsx(StateManagedSelect$1, { placeholder: "Loading...", className: "basic-single", classNamePrefix: "select", isDisabled: true, styles: {
                            ...
                            } }) })] })) : (ReactJSX.jsx(Box, { w: "full", children: apiData && apiData.length > 0 ? (ReactJSX.jsxs(VStack, { w: "full", children: [ReactJSX.jsxs(Flex, { w: "full", children: [ReactJSX.jsx(Text, { fontSize: "18px", color: "#001E4D", children: "Perusahaan" }), ReactJSX.jsx(Text, { color: "red", ml: "4px", children: "*" })] }), ReactJSX.jsx(Box, { w: "full", children: ReactJSX.jsx(StateManagedSelect$1, { placeholder: "Pilih perusahaan", className: "basic-single", classNamePrefix: "select", options: apiData, onChange: handleSelectChange, defaultValue: defaultValue, name: props.properties.perusahaanId.inputID, maxMenuHeight: 250, isSearchable: true, styles: {
                                    container: (baseStyles, state) => (Object.assign(Object.assign({}, baseStyles), { position: "relative" })),
                                    control: (baseStyles, state) => (Object.assign(Object.assign({}, baseStyles), { borderColor: state.isFocused ? "none" : "#E2E8F0", boxShadow: state.isFocused
                                            ? "rgb(49, 130, 206) 0px 0px 0px 1px"
                                            : "none", paddingLeft: "6px", borderRadius: "0.375rem", fontSize: "15px" })),
                                    menu: (baseStyles, state) => (Object.assign(Object.assign({}, baseStyles), { position: "relative", zIndex: "999" })),
                                } }, props.properties.perusahaanId.inputID) })] })) : (ReactJSX.jsxs(VStack, { w: "full", justifyContent: "start", children: [ReactJSX.jsxs(Flex, { w: "full", children: [ReactJSX.jsx(Text, { fontSize: "18px", color: "#001E4D", children: "Perusahaan" }), ReactJSX.jsx(Text, { color: "red.400", ml: "4px", children: "*" })] }), ReactJSX.jsx(Box, { w: "full", children: ReactJSX.jsx(StateManagedSelect$1, { placeholder: "Pilih perusahaan", className: "basic-single", classNamePrefix: "select", styles: {
                                    control: (baseStyles, state) => (Object.assign(Object.assign({}, baseStyles), { borderColor: state.isFocused ? "none" : "#E2E8F0", boxShadow: state.isFocused
                                            ? "rgb(49, 130, 206) 0px 0px 0px 1px"
                                            : "none", paddingLeft: "6px", borderRadius: "0.375rem", fontSize: "15px" })),
                                } }) })] })) })) }));
...
export { dropdownPerusahaan as default };
